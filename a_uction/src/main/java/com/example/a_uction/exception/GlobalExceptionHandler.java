...
public class GlobalExceptionHandler {
	...
	public ErrorResponse handleDataIntegrityViolationException(DataIntegrityViolationException e) {
		...
		return new ErrorResponse(DATABASE_CONSTRAINTS_VIOLATED.getHttpStatus(),
			DATABASE_CONSTRAINTS_VIOLATED,
			DATABASE_CONSTRAINTS_VIOLATED.getDescription());
	}
	@ExceptionHandler(Exception.class)
	public ErrorResponse handleException(Exception e) {
		log.error("Exception is occurred.", e);

		return new ErrorResponse(INTERNAL_SERVER_ERROR.getHttpStatus(),
